...
public class MapRecordSelectActivity extends AppCompatActivity {
    ...
    private static Integer LGAfk, StructureZoneFK,  ManifestStatusFK;
    Spinner LGASpinnerCtrl, StructureZoneSpinnerCtrl, ManifestStatusSpinnerCtrl;
    Button BtnProceed, BtnCancel;
    //JSON Array
    private JSONArray arrayresultforLGA, arrayresultforStructureZones, arrayresultforManifestStatus;
...
//Projects Means Work Type
    ...
    private void getManifestStatus(JSONArray j){
        ...
        //Setting adapter to show the items in the spinner
        ManifestStatusSpinnerCtrl.setAdapter(new ArrayAdapter<String>(MapRecordSelectActivity.this, android.R.layout.simple_spinner_dropdown_item, manifeststatusarraylist));
    }
